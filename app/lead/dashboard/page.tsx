      ...
      <header className="bg-white border-b border-[#E5E7EB]">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-[#6B7280]">Lead Dashboard</p>
          </div>
          <button
            onClick={() => logout()}
      ...
      <main className="max-w-6xl mx-auto px-6 py-12">
        <div className="bg-white rounded-2xl shadow-sm border border-[#E5E7EB] p-8">
          ...
          <p className="text-[#6B7280] mb-6">
            You are logged in as a <span className="font-semibold text-[#F37120]">Lead</span>
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            <div className="bg-gradient-to-br from-[#F37120]/10 to-[#F37120]/5 rounded-xl p-6 border border-[#F37120]/20">
              <h3 className="text-lg font-semibold text-[#111827] mb-2">Pipeline Management</h3>
              <ul className="space-y-2 text-sm text-[#6B7280]">
                <li>✓ View leads</li>
                <li>✓ Track follow-ups</li>
                <li>✓ Manage conversions</li>
                <li>✓ Sales analytics</li>
              </ul>
            </div>

            <div className="bg-gradient-to-br from-green-50 to-green-5 rounded-xl p-6 border border-green-200">
              <h3 className="text-lg font-semibold text-[#111827] mb-2">Key Metrics</h3>
              <p className="text-sm text-[#6B7280]">No data available yet</p>
              <p className="text-xs text-[#9CA3AF] mt-4">Leads data will appear here</p>
            </div>
          </div>

          <div className="mt-8 p-4 bg-[#FEF3E2] rounded-lg border border-[#F37120]/20">
            <p className="text-sm text-[#D97706]">
              <strong>Note:</strong> This is a demonstration dashboard. The full lead management features are being built out.
            </p>
          </div>
        </div>
      </main>
