...
export default function OnboardingPage() {
  ...
  // Welcome subtitle: make ONLY "free assessment" clickable to jump to last slide
  const renderWelcomeSubtitle = (text: string) => {
          ...
          {slides.map((slide, i) => (
            <div key={i} className="relative w-full h-full flex-shrink-0">
              ...
              <div className="absolute inset-x-0 bottom-24 px-6 text-center text-white">
                ...
                {i === 0 ? (
                  renderWelcomeSubtitle(slide.subtitle)
                ) : (
                ...
                <div className="p-5 space-y-3 overflow-y-auto h-[calc(78vh-64px)] md:h-[calc(100%-64px)]">
                  ...
                  <FaqItem q="5. What are your opening hours, and do I need to book ahead?">
                    <ul className="list-disc pl-5 space-y-2">
                      ...
                      <li>
                        <b>Pro tip:</b> It’s best to schedule your sessions in advance to secure your slot.
                      </li>
                    </ul>
                  </FaqItem>
                  ...
                  <FaqItem q="6. What kind of equipment and extra perks do you have?">
                    <ul className="list-disc pl-5 space-y-2">
                      <li>We’re equipped with strength/resistance gear, plus Muay Thai and boxing equipment.</li>
                      <li>If you want the full list, feel free to send us a DM!</li>
                      <li>Shower rooms, lounge area, bicycle rack, drinking water, and free WiFi.</li>
                    </ul>
                  </FaqItem>
                </div>
              </div>
